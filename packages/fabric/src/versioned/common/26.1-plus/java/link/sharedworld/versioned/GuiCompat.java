...
public final class GuiCompat {
    ...
    public static void deferTooltip(GuiGraphicsExtractor guiGraphics, Minecraft minecraft, Component tooltip, int x, int y) {
        guiGraphics.setTooltipForNextFrame(tooltip, x, y);
    }

    public static void deferTooltip(GuiGraphicsExtractor guiGraphics, Minecraft minecraft, List<FormattedCharSequence> lines, int x, int y) {
        guiGraphics.setTooltipForNextFrame(lines, x, y);
    }

    /** Renders the vanilla animated loading dots centered at the given point. */
    public static void renderLoadingDots(GuiGraphicsExtractor guiGraphics, Font font, int centerX, int centerY, float partialTick) {
        ...
        dotsWidget.extractRenderState(guiGraphics, 0, 0, partialTick);
    }
